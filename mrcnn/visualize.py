...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    cv2.imwrite('output.jpeg', masked_image.astype(np.uint8))
...
def display_weight_stats(model):
    ...
    display_table(table)
def save_image(file_names,image, boxes, masks, class_ids, class_names,
                      scores=None, title="",
                      figsize=(16, 16), ax=None,
    ...
    for i in range(N):
        ...
        for verts in contours:
            ...
            ax.add_patch(p)
    ax.imshow(masked_image.astype(np.uint8))
    plt.savefig(save_dir+'/result_'+ file_names,bbox_inches='tight',pad_inches=0.0)